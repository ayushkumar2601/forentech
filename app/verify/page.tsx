...
// //       // ✅ Call your blockchain verify function from API
// //       try {
...
// //       {status === "verified" && (
// //         <p className="text-green-400 text-lg font-semibold">✅ Document is Authentic</p>
// //       )}

// //       {status === "compromised" && (
// //         <p className="text-red-400 text-lg font-semibold">❌ Document has been Tampered</p>
// //       )}

// //       {status === "not-found" && (
// //         <p className="text-yellow-400 text-lg font-semibold">⚠️ No record found on blockchain</p>
// //       )}
// //     </div>
// //   );
// // }
